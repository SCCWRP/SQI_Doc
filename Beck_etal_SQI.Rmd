...
```{r, results = 'asis'}
# use jtools
coef_names <- c("Constant" = "(Intercept)", "log(TN)" = "log10(0.1 + TN)", "log(TP)" = "log10(0.01 + TP)", "Conductivity" = "Cond", "CRAM hydrologic structure" = "hy", "IPI riparian cover" = "XCMG", "IPI percent sands and fines" = "PCT_SAFN")
